...
/// base : "stations"
/// main : {"temp":304.37,"feels_like":306.14,"temp_min":304.37,"temp_max":304.37,"pressure":993,"humidity":50,"sea_level":993,"grnd_level":968}
/// visibility : 10000
/// wind : {"speed":3.11,"deg":348,"gust":3.61}
/// clouds : {"all":100}
/// dt : 1753363173
/// sys : {"country":"PK","sunrise":1753316005,"sunset":1753365871}
/// timezone : 18000
/// id : 1172451
/// name : "Lahore"
/// cod : 200
...
class Sys {
  Sys({String? country, num? sunrise, num? sunset}) {
    _country = country;
    _sunrise = sunrise;
    _sunset = sunset;
  }
  ...
  num? _sunrise;
  num? _sunset;
  Sys copyWith({String? country, num? sunrise, num? sunset}) => Sys(
